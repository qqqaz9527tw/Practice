...
<?php if ($results) { ?>
        <session>
            ...
            <form class="update" action="." method="POST">
                ...
                <input type="text" id="countrycode-<?= $id ?>" name="countrycode" value="<?= $countrycode ?>" required>
                
                <label for="district-<?= $id ?>">District:</label>
                <input type="text" id="district-<?= $id ?>" name="district" value="<?= $district ?>" required>
                
                <label for="population-<?= $id ?>">Population:</label>
                <input type="text" id="population-<?= $id ?>" name="population" value="<?= $population ?>" required>
