...
<section id="special-price">
      <div class="container ">
        <h4 class="font-runik font-size-20">Special Price</h4>
          ...
          <div class="grid-item border <?php echo $item['item_brand'] ?? "Brand";?>">
           <div class="item py-2" style="width: 200px;">
            <div class="product font-rale">
              <a href="<?php printf('%s?item_id=%s', 'product.php', $item['item_id']);?>"><img src="<?php echo $item['item_image']??"./assets/products/4.png";?>" alt="product1" class="img-fluid" width="200px" height="100px"></a>
